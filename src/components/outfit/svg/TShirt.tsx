...
export default function TShirt({ className }: Props) {
  return (
    <OutfitIcon label="Short sleeve shirt" className={className}>
      <path
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M40 25q10 13 20 0" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </OutfitIcon>
  );
}
