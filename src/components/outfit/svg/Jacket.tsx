...
export default function Jacket({ className }: Props) {
  return (
    <OutfitIcon label="Light jacket" className={className}>
      <path
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M50 25v50M42 20h16v5H42z" stroke="currentColor" strokeWidth="2.5" strokeLinejoin="round" />
    </OutfitIcon>
  );
}
